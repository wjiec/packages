...
![二哈直方图](http://doulemd.iok.la/static_images/97a32fca2d4e9389d0e4025006b96686.png)

现在我们已经知道怎么得到一张图片的直方图了，所以接下来最主要的就是怎么计算两张图片的直方图的差异。
计算差异都多种办法，以下仅列举两种常见的计算差异的方法

第一种计算差异的方法通过数学解释：
![第一种计算差异的方法](http://doulemd.iok.la/static_images/714b27b324124880aabc310447016327.png)

第二种计算差异的方法通过数学解释：
![第二种计算差异的方法](http://doulemd.iok.la/static_images/8761d42de0348e350e43ddae91ba81e7.png)
...
![对比](http://doulemd.iok.la/static_images/4e323d33d409f2521cefb8f6aed72e76.png)
...
![相同的图片](http://doulemd.iok.la/static_images/7145fc5d7e65299f390942b93b0e8f11.png)
...
![meizi](http://doulemd.iok.la/static_images/cd153aa780a206952a54899aed6a5957.png)
...
# 显示图片省略
```
![对比](http://doulemd.iok.la/static_images/5d3da7126276cb4188ebee526f0ea3fb.png)
...
![rst](http://doulemd.iok.la/static_images/aba57172be28b42cfac0ebf443ac2286.png)
