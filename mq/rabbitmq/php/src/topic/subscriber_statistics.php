...
$channel->queue_declare('logs_topic_statistics', false, false, false, true);
$channel->queue_bind('logs_topic_statistics', 'logs_topic', 'statistics.*');

$channel->basic_qos(null, 1, true);
$channel->basic_consume('logs_topic_statistics', null, false, false, false, false,
