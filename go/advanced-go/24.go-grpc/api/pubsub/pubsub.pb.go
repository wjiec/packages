...
var file_pubsub_proto_rawDesc = []byte{
	...
	,
...
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: pubsub.PubSubService.Publish:input_type -> pubsub.Topic
	0, // 1: pubsub.PubSubService.Subscribe:input_type -> pubsub.Topic
	0, // 2: pubsub.PubSubService.Publish:output_type -> pubsub.Topic
	0, // 3: pubsub.PubSubService.Subscribe:output_type -> pubsub.Topic
...
type PubSubServiceClient interface {
	Publish(ctx context.Context, in *Topic, opts ...grpc.CallOption) (*Topic, error)
...
func (c *pubSubServiceClient) Publish(ctx context.Context, in *Topic, opts ...grpc.CallOption) (*Topic, error) {
	out := new(Topic)
...
func (x *pubSubServiceSubscribeClient) Recv() (*Topic, error) {
	m := new(Topic)
...
type PubSubServiceServer interface {
	Publish(context.Context, *Topic) (*Topic, error)
...
func (*UnimplementedPubSubServiceServer) Publish(context.Context, *Topic) (*Topic, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Publish not implemented")
}
func (*UnimplementedPubSubServiceServer) Subscribe(*Topic, PubSubService_SubscribeServer) error {
...
func (x *pubSubServiceSubscribeServer) Send(m *Topic) error {
